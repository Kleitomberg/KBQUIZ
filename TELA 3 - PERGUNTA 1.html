...
<p class="perguntas"> 1° Qual é o maior campeão brasileiro de futebol da serie A?</p>

</div>
<div id="resposta">
<form action="TELA 4 - PERGUNTA 2.html" method="post" id="alternativas">
A)
<input type="radio" class="caixinha" name="op" value="Flamengo"> Flamengo</br>
B)
...
D)
<input type="radio" class="caixinha" name="op" value="Corinthians"> Corinthians </br>
<div id="botões">
